...
# By default all these toolchains are registered by the conftest_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:conftest_toolchain",
    toolchain_type = "@ohno_cloud_tools_manifests//conftest:toolchain_type",
)
""".format(
            platform = platform,
